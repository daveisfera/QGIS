...
#ifndef QGSIFEATURESELECTION_H
#define QGSIFEATURESELECTION_H
...
class QgsIFeatureSelection : public QObject
{
    Q_OBJECT

  public:
    QgsIFeatureSelection( QObject* parent )
        : QObject( parent ) {}
