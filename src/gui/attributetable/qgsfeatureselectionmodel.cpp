...
QgsFeatureSelectionModel::QgsFeatureSelectionModel( QAbstractItemModel* model, QgsFeatureModel* featureModel, QgsIFeatureSelection* featureSelectionManager, QObject* parent )
...
void QgsFeatureSelectionModel::setFeatureSelectionManager( QgsIFeatureSelection* featureSelectionManager )
{
