...
class QgsIFeatureSelection;

class GUI_EXPORT QgsFeatureSelectionModel : public QItemSelectionModel
{
    Q_OBJECT
  public:
    explicit QgsFeatureSelectionModel( QAbstractItemModel* model, QgsFeatureModel* featureModel, QgsIFeatureSelection* featureSelectionHandler, QObject* parent );
  ...
  public slots:
    ...
    virtual void setFeatureSelectionManager( QgsIFeatureSelection* featureSelectionManager );
